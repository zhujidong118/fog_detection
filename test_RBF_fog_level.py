...
class RBF_NN():
    def __init__(self, hidden_nodes, input_data_trainX, input_data_trainY, maxCycle, learn_eff):
        ...
        self.maxCycle = maxCycle  # 最大迭代次数
        self.learn_eff = learn_eff  # 学习率
    ...
    def fit(self):
        ...
        train_op = tf.train.GradientDescentOptimizer(self.learn_eff).minimize(cost)  # 优化算法为梯度下降法
...
if __name__ == '__main__':
    print('------------------------1.Load Data---------------------')
    trainX, trainY = load_data('./num_data/all_100_st.txt')
    ...
    rbf = RBF_NN(hidden_nodes, input_data_trainX, input_data_trainY, 10000, 0.009)
    rbf.fit()
